...
import { Bookmark, MessageSquare, GraduationCap, ArrowRight, ExternalLink, Trash2 } from "lucide-react"
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center justify-between">
            <div className="space-y-2 max-w-xl text-center md:text-left">
              <div className="inline-flex items-center rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-sm font-medium text-amber-500 mb-1">
                <Bookmark className="mr-2 h-4 w-4 fill-amber-500/20" /> Dashboard
              </div>
              <h1 className="text-3xl font-bold tracking-tight text-foreground">
                Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Bookmarks</span>
              </h1>
              <p className="text-muted-foreground text-sm">
                Access your bookmarked discussions and mentors.
              </p>
            </div>
          </div>
