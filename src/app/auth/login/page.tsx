...
import { Mail, ArrowRight, Code, Lock, Eye, EyeOff, Loader2 } from "lucide-react"
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
      ...
      >
        <Card className="border-primary/20 bg-background/60 backdrop-blur-2xl shadow-[0_0_50px_rgba(79,70,229,0.15)] relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary via-purple-500 to-cyan-400" />

          <CardHeader className="space-y-3 pb-6 text-center pt-8">
            <div className="mx-auto bg-primary/10 w-12 h-12 rounded-full flex items-center justify-center mb-2 ring-1 ring-primary/30">
