...
import { Mail, ArrowRight, Code, User } from "lucide-react"
...
export default function SignupPage() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    e.preventDefault()
    login() // Log the user in after signing up
        ...
        <Card className="border-primary/20 bg-background/60 backdrop-blur-2xl shadow-[0_0_50px_rgba(79,70,229,0.15)] relative overflow-hidden">
          ...
          <CardContent className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="w-full h-11 bg-background/50 hover:bg-background/80">
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-11 bg-gradient-to-r from-purple-600 to-primary hover:from-purple-600/90 hover:to-primary/90 text-white shadow-lg shadow-purple-600/25 mt-2">
