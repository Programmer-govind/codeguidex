    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
      ...
      <div className="mt-4 flex gap-2 justify-end">
        <button
          ...
          className="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg text-sm hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Clear
        </button>
        <button
          ...
          disabled={isSubmitting || isLoading || !content.trim()}
          className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
        >
